...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "bispec_cov_solver.pyx"
        ]
    },
    "module_name": "bispec_cov_solver"
}
END: Cython Metadata */
...
#define __PYX_HAVE__bispec_cov_solver
#define __PYX_HAVE_API__bispec_cov_solver
/* Early includes */
#include <string.h>
#include <stdio.h>
#ifdef _OPENMP
...
#define __Pyx_MODULE_NAME "bispec_cov_solver"
extern int __pyx_module_is_main_bispec_cov_solver;
int __pyx_module_is_main_bispec_cov_solver = 0;

/* Implementation of "bispec_cov_solver" */
...
#define __pyx_kp_b_int_double_double_double_double __pyx_string_tab[9]
 ...
 * cdef int soe_solver(
*/
  __pyx_r = ((__pyx_v_X * __pyx_v_n_tracers) + __pyx_v_Y);
  goto __pyx_L0;
...
static int __pyx_f_17bispec_cov_solver_soe_solver(double *__pyx_v_matrix, double *__pyx_v_vec, double *__pyx_v_sol, double *__pyx_v_A, double *__pyx_v_b, double *__pyx_v_y, int __pyx_v_n_tracers) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_pivot_row;
  double __pyx_v_maxabs;
  double __pyx_v_tmp;
  double __pyx_v_piv;
  int __pyx_r;
  int __pyx_t_1;
...
*/
  while (1) {
    __pyx_t_1 = (__pyx_v_i < __Pyx_pow_long(((long)__pyx_v_n_tracers), 2));
    if (!__pyx_t_1) break;

    /* "bispec_cov_solver.pyx":29
 * 
 *     while i  < n_tracers**2:
 *         A[i] = matrix[i]             # <<<<<<<<<<<<<<
 *         i+=1
 *     i=0
*/
    (__pyx_v_A[__pyx_v_i]) = (__pyx_v_matrix[__pyx_v_i]);

    /* "bispec_cov_solver.pyx":30
 *     while i  < n_tracers**2:
 *         A[i] = matrix[i]
 *         i+=1             # <<<<<<<<<<<<<<
 *     i=0
...
*/
  while (1) {
    __pyx_t_1 = (__pyx_v_i < __pyx_v_n_tracers);
    if (!__pyx_t_1) break;

    /* "bispec_cov_solver.pyx":34
 * 
 *     while i < n_tracers:
 *         b[i] = vec[i]             # <<<<<<<<<<<<<<
 *         i+=1
 *     i=0
*/
    (__pyx_v_b[__pyx_v_i]) = (__pyx_v_vec[__pyx_v_i]);

    /* "bispec_cov_solver.pyx":35
 *     while i < n_tracers:
 *         b[i] = vec[i]
 *         i+=1             # <<<<<<<<<<<<<<
 *     i=0
 ...
 *         if maxabs < 0.0:
*/
    __pyx_v_pivot_row = __pyx_v_i;

    /* "bispec_cov_solver.pyx":41
 *     while i < n_tracers:
 *         pivot_row = i
 *         maxabs = A[index_2d(i, i, n_tracers)]             # <<<<<<<<<<<<<<
 *         if maxabs < 0.0:
 *             maxabs = -1*maxabs
*/
    __pyx_v_maxabs = (__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_i, __pyx_v_i, __pyx_v_n_tracers)]);

    /* "bispec_cov_solver.pyx":42
 *         pivot_row = i
 *         maxabs = A[index_2d(i, i, n_tracers)]
 *         if maxabs < 0.0:             # <<<<<<<<<<<<<<
 *             maxabs = -1*maxabs
 * 
*/
    __pyx_t_1 = (__pyx_v_maxabs < 0.0);
    if (__pyx_t_1) {

      /* "bispec_cov_solver.pyx":43
 *         maxabs = A[index_2d(i, i, n_tracers)]
 *         if maxabs < 0.0:
 *             maxabs = -1*maxabs             # <<<<<<<<<<<<<<
 * 
...
*/
      __pyx_v_maxabs = (-1.0 * __pyx_v_maxabs);
...
*/
    while (1) {
      __pyx_t_1 = (__pyx_v_j < __pyx_v_n_tracers);
      if (!__pyx_t_1) break;

      /* "bispec_cov_solver.pyx":49
 *         while j < n_tracers:
 * 
 *             tmp = A[index_2d(j, i, n_tracers)]             # <<<<<<<<<<<<<<
 *             if tmp < 0.0:
 *                 tmp = -tmp
*/
      __pyx_v_tmp = (__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_j, __pyx_v_i, __pyx_v_n_tracers)]);

      /* "bispec_cov_solver.pyx":50
 * 
 *             tmp = A[index_2d(j, i, n_tracers)]
 *             if tmp < 0.0:             # <<<<<<<<<<<<<<
 *                 tmp = -tmp
 ...
 *                 pivot_row = j
*/
      __pyx_t_1 = (__pyx_v_tmp > __pyx_v_maxabs);
      if (__pyx_t_1) {

        /* "bispec_cov_solver.pyx":53
 *                 tmp = -tmp
 *             if tmp > maxabs:
 *                 maxabs = tmp             # <<<<<<<<<<<<<<
 *                 pivot_row = j
 *             j+=1
*/
        __pyx_v_maxabs = __pyx_v_tmp;

        /* "bispec_cov_solver.pyx":54
 *             if tmp > maxabs:
 *                 maxabs = tmp
 *                 pivot_row = j             # <<<<<<<<<<<<<<
 *             j+=1
 ...
 *             while j < n_tracers:
*/
    __pyx_t_1 = (__pyx_v_pivot_row != __pyx_v_i);
    if (__pyx_t_1) {

      /* "bispec_cov_solver.pyx":62
 *         if pivot_row != i:
 *             # j goes over the elements within a row here
 *             while j < n_tracers:             # <<<<<<<<<<<<<<
...
*/
        __pyx_v_tmp = (__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_i, __pyx_v_j, __pyx_v_n_tracers)]);

        /* "bispec_cov_solver.pyx":64
 *             while j < n_tracers:
 *                 tmp = A[index_2d(i, j, n_tracers)]
 *                 A[index_2d(i, j, n_tracers)] = A[index_2d(pivot_row, j, n_tracers)]             # <<<<<<<<<<<<<<
 *                 A[index_2d(pivot_row, j, n_tracers)] = tmp
 *                 j+=1
*/
        (__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_i, __pyx_v_j, __pyx_v_n_tracers)]) = (__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_pivot_row, __pyx_v_j, __pyx_v_n_tracers)]);

        /* "bispec_cov_solver.pyx":65
 *                 tmp = A[index_2d(i, j, n_tracers)]
 *                 A[index_2d(i, j, n_tracers)] = A[index_2d(pivot_row, j, n_tracers)]
 *                 A[index_2d(pivot_row, j, n_tracers)] = tmp             # <<<<<<<<<<<<<<
 *                 j+=1
 *             j=0
*/
        (__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_pivot_row, __pyx_v_j, __pyx_v_n_tracers)]) = __pyx_v_tmp;

        /* "bispec_cov_solver.pyx":66
 *                 A[index_2d(i, j, n_tracers)] = A[index_2d(pivot_row, j, n_tracers)]
 *                 A[index_2d(pivot_row, j, n_tracers)] = tmp
 *                 j+=1             # <<<<<<<<<<<<<<
 *             j=0
 ...
 *             b[pivot_row] = tmp
*/
      __pyx_v_tmp = (__pyx_v_b[__pyx_v_i]);

      /* "bispec_cov_solver.pyx":70
 * 
 *             tmp = b[i]
 *             b[i] = b[pivot_row]             # <<<<<<<<<<<<<<
 *             b[pivot_row] = tmp
 * 
*/
      (__pyx_v_b[__pyx_v_i]) = (__pyx_v_b[__pyx_v_pivot_row]);

      /* "bispec_cov_solver.pyx":71
 *             tmp = b[i]
 *             b[i] = b[pivot_row]
 *             b[pivot_row] = tmp             # <<<<<<<<<<<<<<
 * 
...
*/
      (__pyx_v_b[__pyx_v_pivot_row]) = __pyx_v_tmp;
 ...
 *         while j < n_tracers:
*/
    __pyx_v_piv = (__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_i, __pyx_v_i, __pyx_v_n_tracers)]);

    /* "bispec_cov_solver.pyx":75
 *         # eliminate entries below pivot
 *         piv = A[index_2d(i, i, n_tracers)]
 *         j = i+1             # <<<<<<<<<<<<<<
 *         while j < n_tracers:
 ...
 * 
*/
      __pyx_t_2 = __pyx_f_17bispec_cov_solver_index_2d(__pyx_v_j, __pyx_v_i, __pyx_v_n_tracers);
      (__pyx_v_A[__pyx_t_2]) = ((__pyx_v_A[__pyx_t_2]) / __pyx_v_piv);

      /* "bispec_cov_solver.pyx":78
 *         while j < n_tracers:
 *             A[index_2d(j, i, n_tracers)] /= piv # L value (A contains L and U at the same time)
 *             tmp = A[index_2d(j, i, n_tracers)]             # <<<<<<<<<<<<<<
 * 
...
*/
      while (1) {
        __pyx_t_1 = (__pyx_v_k < __pyx_v_n_tracers);
        if (!__pyx_t_1) break;

        /* "bispec_cov_solver.pyx":83
 *             k = i+1
 *             while k < n_tracers:
 *                 A[index_2d(j, k, n_tracers)] -= tmp * A[index_2d(i, k, n_tracers)]             # <<<<<<<<<<<<<<
 *                 k += 1
 *             k = 0
*/
        __pyx_t_2 = __pyx_f_17bispec_cov_solver_index_2d(__pyx_v_j, __pyx_v_k, __pyx_v_n_tracers);
        (__pyx_v_A[__pyx_t_2]) = ((__pyx_v_A[__pyx_t_2]) - (__pyx_v_tmp * (__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_i, __pyx_v_k, __pyx_v_n_tracers)])));

        /* "bispec_cov_solver.pyx":84
 *             while k < n_tracers:
 *                 A[index_2d(j, k, n_tracers)] -= tmp * A[index_2d(i, k, n_tracers)]
 *                 k += 1             # <<<<<<<<<<<<<<
 *             k = 0
 ...
 *         j=0
*/
      __pyx_v_tmp = (__pyx_v_tmp - ((__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_i, __pyx_v_j, __pyx_v_n_tracers)]) * (__pyx_v_y[__pyx_v_j])));

      /* "bispec_cov_solver.pyx":96
 *         while j < i:
 *             tmp -= A[index_2d(i, j, n_tracers)] * y[j]
 *             j+=1             # <<<<<<<<<<<<<<
 *         j=0
 ...
 *         tmp = y[i]
*/
  __pyx_v_i = (__pyx_v_n_tracers - 1);

  /* "bispec_cov_solver.pyx":104
 * 
 *     i = n_tracers - 1
 *     while i > -1:             # <<<<<<<<<<<<<<
 *         tmp = y[i]
 ...
 *             j+=1
*/
      __pyx_v_tmp = (__pyx_v_tmp - ((__pyx_v_A[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_i, __pyx_v_j, __pyx_v_n_tracers)]) * (__pyx_v_sol[__pyx_v_j])));

      /* "bispec_cov_solver.pyx":111
 *             tmp -= A[index_2d(i, j, n_tracers)] * sol[j]
 * 
 *             j+=1             # <<<<<<<<<<<<<<
 *         j=0
 ...
 *         i-=1
*/
    (__pyx_v_sol[__pyx_v_i]) = (__pyx_v_tmp / __pyx_v_piv);

    /* "bispec_cov_solver.pyx":117
 *         sol[i] =  tmp / piv
 * 
 *         i-=1             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_f_17bispec_cov_solver_solve_1(double *__pyx_v_CXp, int __pyx_v_Yp, int __pyx_v_Zp, double *__pyx_v_bispec_vec, double *__pyx_v_outn, double *__pyx_v_vec, double *__pyx_v_A_solve, double *__pyx_v_b_solve, double *__pyx_v_y_solve, int __pyx_v_n_tracers) {
  int __pyx_v_Xp;
  int __pyx_r;
  int __pyx_t_1;

  /* "bispec_cov_solver.pyx":134
 *     ) noexcept nogil:
...
*/
  while (1) {
    __pyx_t_1 = (__pyx_v_Xp < __pyx_v_n_tracers);
    if (!__pyx_t_1) break;

    /* "bispec_cov_solver.pyx":136
 *     cdef int Xp = 0
 *     while Xp < n_tracers:
 *         vec[Xp] = bispec_vec[index_3d(Xp, Yp, Zp, n_tracers)]             # <<<<<<<<<<<<<<
 *         Xp += 1
 * 
*/
    (__pyx_v_vec[__pyx_v_Xp]) = (__pyx_v_bispec_vec[__pyx_f_17bispec_cov_solver_index_3d(__pyx_v_Xp, __pyx_v_Yp, __pyx_v_Zp, __pyx_v_n_tracers)]);

    /* "bispec_cov_solver.pyx":137
 *     while Xp < n_tracers:
 *         vec[Xp] = bispec_vec[index_3d(Xp, Yp, Zp, n_tracers)]
 *         Xp += 1             # <<<<<<<<<<<<<<
 * 
...
*/
    __pyx_v_Xp = (__pyx_v_Xp + 1);
  }

  /* "bispec_cov_solver.pyx":139
 *         Xp += 1
 * 
 *     soe_solver(CXp, vec, outn, A_solve, b_solve, y_solve, n_tracers) # so this will be a vector. for given XYZ this function is just a function of Yp and Zp             # <<<<<<<<<<<<<<
 *     return 0
 * 
*/
  (void)(__pyx_f_17bispec_cov_solver_soe_solver(__pyx_v_CXp, __pyx_v_vec, __pyx_v_outn, __pyx_v_A_solve, __pyx_v_b_solve, __pyx_v_y_solve, __pyx_v_n_tracers));

  /* "bispec_cov_solver.pyx":140
 * 
 *     soe_solver(CXp, vec, outn, A_solve, b_solve, y_solve, n_tracers) # so this will be a vector. for given XYZ this function is just a function of Yp and Zp
 *     return 0             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_f_17bispec_cov_solver_solve_2(double *__pyx_v_CXp, double *__pyx_v_CYp, int __pyx_v_Zp, double *__pyx_v_bispec_vec, double *__pyx_v_outn2, double *__pyx_v_vecs, double *__pyx_v_b, double *__pyx_v_x, double *__pyx_v_vec_solve1, double *__pyx_v_A_solve, double *__pyx_v_b_solve, double *__pyx_v_y_solve, int __pyx_v_n_tracers) {
  int __pyx_v_Xp;
  int __pyx_v_Yp;
  int __pyx_r;
  int __pyx_t_1;

  /* "bispec_cov_solver.pyx":158
 *     ) noexcept nogil:
 * 
 *     cdef int Xp = 0             # <<<<<<<<<<<<<<
 *     cdef int Yp = 0
...
*/
  while (1) {
    __pyx_t_1 = (__pyx_v_Yp < __pyx_v_n_tracers);
    if (!__pyx_t_1) break;

    /* "bispec_cov_solver.pyx":164
 *     Yp=0
 *     while Yp < n_tracers:
 *         solve_1(CXp, Yp, Zp, bispec_vec, x, vec_solve1, A_solve, b_solve, y_solve, n_tracers) # in python language: x = solve_1(...)             # <<<<<<<<<<<<<<
 *         Xp=0
 *         while Xp < n_tracers:
*/
    (void)(__pyx_f_17bispec_cov_solver_solve_1(__pyx_v_CXp, __pyx_v_Yp, __pyx_v_Zp, __pyx_v_bispec_vec, __pyx_v_x, __pyx_v_vec_solve1, __pyx_v_A_solve, __pyx_v_b_solve, __pyx_v_y_solve, __pyx_v_n_tracers));

    /* "bispec_cov_solver.pyx":165
 *     while Yp < n_tracers:
 *         solve_1(CXp, Yp, Zp, bispec_vec, x, vec_solve1, A_solve, b_solve, y_solve, n_tracers) # in python language: x = solve_1(...)
 *         Xp=0             # <<<<<<<<<<<<<<
 *         while Xp < n_tracers:
 ...
 *         Yp += 1
*/
      (__pyx_v_vecs[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_Xp, __pyx_v_Yp, __pyx_v_n_tracers)]) = (__pyx_v_x[__pyx_v_Xp]);

      /* "bispec_cov_solver.pyx":168
 *         while Xp < n_tracers:
 *             vecs[index_2d(Xp, Yp, n_tracers)] = x[Xp]
 *             Xp += 1             # <<<<<<<<<<<<<<
 *         Yp += 1
...
*/
    __pyx_v_Yp = (__pyx_v_Yp + 1);
  }

  /* "bispec_cov_solver.pyx":172
 * 
 *     # for each Xp, solve along Y: Cy * y = vecs[Xp,:]
 *     Xp=0             # <<<<<<<<<<<<<<
 *     while Xp < n_tracers:
...
*/
      (__pyx_v_b[__pyx_v_Yp]) = (__pyx_v_vecs[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_Xp, __pyx_v_Yp, __pyx_v_n_tracers)]);

      /* "bispec_cov_solver.pyx":177
 *         while Yp < n_tracers:
 *             b[Yp] = vecs[index_2d(Xp, Yp, n_tracers)]
 *             Yp += 1             # <<<<<<<<<<<<<<
 *         soe_solver(CYp, b, x, A_solve, b_solve, y_solve, n_tracers)
 ...
 *         while Yp < n_tracers:
*/
    (void)(__pyx_f_17bispec_cov_solver_soe_solver(__pyx_v_CYp, __pyx_v_b, __pyx_v_x, __pyx_v_A_solve, __pyx_v_b_solve, __pyx_v_y_solve, __pyx_v_n_tracers));

    /* "bispec_cov_solver.pyx":179
 *             Yp += 1
 *         soe_solver(CYp, b, x, A_solve, b_solve, y_solve, n_tracers)
 *         Yp=0             # <<<<<<<<<<<<<<
 *         while Yp < n_tracers:
 ...
 *         Xp += 1
*/
      (__pyx_v_outn2[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_Xp, __pyx_v_Yp, __pyx_v_n_tracers)]) = (__pyx_v_x[__pyx_v_Yp]);

      /* "bispec_cov_solver.pyx":182
 *         while Yp < n_tracers:
 *             outn2[index_2d(Xp, Yp, n_tracers)] = x[Yp]
 *             Yp += 1             # <<<<<<<<<<<<<<
 *         Xp += 1
...
static int __pyx_f_17bispec_cov_solver_solve_3(double *__pyx_v_CXp, double *__pyx_v_CYp, double *__pyx_v_CZp, double *__pyx_v_bispec_vec, double *__pyx_v_outn3, double *__pyx_v_vecss, double *__pyx_v_b, double *__pyx_v_x, double *__pyx_v_x2, double *__pyx_v_vecs_solve2, double *__pyx_v_b_solve2, double *__pyx_v_x_solve2, double *__pyx_v_vec_solve1, double *__pyx_v_A_solve, double *__pyx_v_b_solve, double *__pyx_v_y_solve, int __pyx_v_n_tracers) {
  int __pyx_v_Xp;
  int __pyx_v_Yp;
  int __pyx_v_Zp;
  int __pyx_r;
...
*/
  while (1) {
    __pyx_t_1 = (__pyx_v_Zp < __pyx_v_n_tracers);
    if (!__pyx_t_1) break;

    /* "bispec_cov_solver.pyx":213
 *     Zp = 0
 *     while Zp < n_tracers:
 *         solve_2(CXp, CYp, Zp, bispec_vec, x2, vecs_solve2, b_solve2, x_solve2, vec_solve1, A_solve, b_solve, y_solve, n_tracers) # in python language: x2 = solve_2(...)             # <<<<<<<<<<<<<<
 *         Yp = 0
 *         while Yp < n_tracers:
*/
    (void)(__pyx_f_17bispec_cov_solver_solve_2(__pyx_v_CXp, __pyx_v_CYp, __pyx_v_Zp, __pyx_v_bispec_vec, __pyx_v_x2, __pyx_v_vecs_solve2, __pyx_v_b_solve2, __pyx_v_x_solve2, __pyx_v_vec_solve1, __pyx_v_A_solve, __pyx_v_b_solve, __pyx_v_y_solve, __pyx_v_n_tracers));

    /* "bispec_cov_solver.pyx":214
 *     while Zp < n_tracers:
 *         solve_2(CXp, CYp, Zp, bispec_vec, x2, vecs_solve2, b_solve2, x_solve2, vec_solve1, A_solve, b_solve, y_solve, n_tracers) # in python language: x2 = solve_2(...)
 *         Yp = 0             # <<<<<<<<<<<<<<
 *         while Yp < n_tracers:
 ...
 *             Yp += 1
*/
        (__pyx_v_vecss[__pyx_f_17bispec_cov_solver_index_3d(__pyx_v_Xp, __pyx_v_Yp, __pyx_v_Zp, __pyx_v_n_tracers)]) = (__pyx_v_x2[__pyx_f_17bispec_cov_solver_index_2d(__pyx_v_Xp, __pyx_v_Yp, __pyx_v_n_tracers)]);

        /* "bispec_cov_solver.pyx":219
 *             while Xp < n_tracers:
 *                 vecss[index_3d(Xp, Yp, Zp, n_tracers)] = x2[index_2d(Xp, Yp, n_tracers)]
 *                 Xp += 1             # <<<<<<<<<<<<<<
 *             Yp += 1
...
*/
    __pyx_v_Zp = (__pyx_v_Zp + 1);
  }

  /* "bispec_cov_solver.pyx":224
 * 
 *     # for each Xp, Yp, solve along Z: Cz * z = vecs[Zp,:]
 *     Xp = 0             # <<<<<<<<<<<<<<
 *     while Xp < n_tracers:
...
*/
        (__pyx_v_b[__pyx_v_Zp]) = (__pyx_v_vecss[__pyx_f_17bispec_cov_solver_index_3d(__pyx_v_Xp, __pyx_v_Yp, __pyx_v_Zp, __pyx_v_n_tracers)]);

        /* "bispec_cov_solver.pyx":231
 *             while Zp < n_tracers:
 *                 b[Zp] = vecss[index_3d(Xp, Yp, Zp, n_tracers)]
 *                 Zp += 1             # <<<<<<<<<<<<<<
 *             soe_solver(CZp, b, x, A_solve, b_solve, y_solve, n_tracers)
 ...
 *             while Zp < n_tracers:
*/
      (void)(__pyx_f_17bispec_cov_solver_soe_solver(__pyx_v_CZp, __pyx_v_b, __pyx_v_x, __pyx_v_A_solve, __pyx_v_b_solve, __pyx_v_y_solve, __pyx_v_n_tracers));

      /* "bispec_cov_solver.pyx":233
 *                 Zp += 1
 *             soe_solver(CZp, b, x, A_solve, b_solve, y_solve, n_tracers)
 *             Zp = 0             # <<<<<<<<<<<<<<
 *             while Zp < n_tracers:
 ...
 *             Yp += 1
*/
        (__pyx_v_outn3[__pyx_f_17bispec_cov_solver_index_3d(__pyx_v_Xp, __pyx_v_Yp, __pyx_v_Zp, __pyx_v_n_tracers)]) = (__pyx_v_x[__pyx_v_Zp]);

        /* "bispec_cov_solver.pyx":236
 *             while Zp < n_tracers:
 *                 outn3[index_3d(Xp, Yp, Zp, n_tracers)] = x[Zp]
 *                 Zp += 1             # <<<<<<<<<<<<<<
 *             Yp += 1
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    const char * __pyx_export_signature = __Pyx_PyBytes_AsString(__pyx_mstate_global->__pyx_kp_b_int_double_double_double_double);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (unlikely(!__pyx_export_signature)) __PYX_ERR(0, 1, __pyx_L1_error)
    #endif
    const char * __pyx_export_name = __pyx_export_signature + 215;
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_17bispec_cov_solver_solve_3, (void (*)(void))&__pyx_f_17bispec_cov_solver_index_2d, (void (*)(void))&__pyx_f_17bispec_cov_solver_index_3d, (void (*)(void)) NULL};
...
static int __pyx_pymod_exec_bispec_cov_solver(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_bispec_cov_solver},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_bispec_cov_solver(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_bispec_cov_solver(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_bispec_cov_solver(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'bispec_cov_solver' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "bispec_cov_solver" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_bispec_cov_solver", 0);
  ...
  if (__pyx_module_is_main_bispec_cov_solver) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "bispec_cov_solver")) {
      if (unlikely((PyDict_SetItemString(modules, "bispec_cov_solver", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init bispec_cov_solver", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init bispec_cov_solver");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{18},{8},{10},{8},{12},{12},{10},{8},{240}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (124 bytes) */
const char* const cstring = "(\265/\375`G\000\225\003\000\"\207\025\026\220Mc\360-\000r\331\304\002\222\333Rr\217\343t\320rw\347\007\354`\306\0242M\340\030\247\326D\300\260\232AA\004\330\022\251aB\260\232\277\021\356o\223NA\266\030\265\223\236\377tnMU\016s\372\217Mb\r\363\257y\314/\353\022\\\007\355\232\243f[H\t\000X\262\345\331\301\315\t2\005\000\000-s\351LZ\350\263s\226^\267\014";
    PyObject *data = __Pyx_DecompressString(cstring, 124, 3);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (158 bytes) */
const char* const cstring = "BZh91AY&SY;\207\032\233\000\000/\333\200@\000@t\030\000\200\000\277/\377` \000\224\tI\244\237\252~\251\351\033\024\303S\324\332@\222H4z\215\000\000\021\225\003\203t\257\000t\"\2452`\007\000\202)Q`\366-\0008\211\253m\025e`o\272\333\031\034Y\362\000{\026\266\372H\266\310\211{\200u\n\rN<t\245qJ\340\315T\321\t\302\031\356\001\262\272\325\342=\310IDJ\316`\014\305\035iTC\274\243\330\353\310\004\244\314~\327\370\273\222)\302\204\201\3348\324\330";
    PyObject *data = __Pyx_DecompressString(cstring, 158, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
...
const char* const cstring = "x\332\315\2161\016\2030\014E{\224\214m\305T\016\300Q,\023\033)\302Ih\343T\364\366\230\300\332\035\017\337\357\177{\370\203\227\220\030B\002\375\240\347\021\375\014\020\321\274M\314T\205wJ\030\333^~+x\\\302\316\357\212r\344\205\225x\302*\n\240\\LCRw\247\\Ga\367\354\3345\311J>n\255\251I\263\177\263\363P\262|\031z{ ^\341E'\364\264\001\237Bm\304";
...
const char* const bytes = "?cline_in_traceback__main____module____name____pyx_capi____qualname__setdefault__test__int (double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, int)\000int (int, int, int)\000int (int, int, int, int)\000solve_3\000index_2d\000index_3d";
    PyObject *data = NULL;
