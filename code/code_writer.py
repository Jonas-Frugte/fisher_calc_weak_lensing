...
cdef double[:, :] cmbps_{cosm_par}_{pm}_{delta_delta_coeff} = np.zeros((lmax_cmbps+1, 5), dtype=np.float64)

cosm_par_{cosm_par}_{pm}_{delta_delta_coeff}, C_{cosm_par}_{pm}_{delta_delta_coeff}, a_data_{cosm_par}_{pm}_{delta_delta_coeff}, b_data_{cosm_par}_{pm}_{delta_delta_coeff}, c_data_{cosm_par}_{pm}_{delta_delta_coeff}, lps_cc_data_{cosm_par}_{pm}_{delta_delta_coeff}, lps_cs_data_{cosm_par}_{pm}_{delta_delta_coeff}, lps_ss_data_{cosm_par}_{pm}_{delta_delta_coeff}, scale_factor_data_{cosm_par}_{pm}_{delta_delta_coeff}, window_c_data_{cosm_par}_{pm}_{delta_delta_coeff}, window_s_data_{cosm_par}_{pm}_{delta_delta_coeff}, mps_data_{cosm_par}_{pm}_{delta_delta_coeff}, z_at_chi_data_{cosm_par}_{pm}_{delta_delta_coeff}, cmbps_{cosm_par}_{pm}_{delta_delta_coeff} = data_import_func('data_{cosm_par}_{pm}_{delta_delta_coeff}')

cdef double lbs_{cosm_par}_{pm}_{delta_delta_coeff}(int k1, int k2, int k3, char* type1, char* type2, char* type3, int num_samples, bint pb_correction) noexcept nogil:
    return lbs(k1, k2, k3, type1, type2, type3, num_samples, pb_correction, C_{cosm_par}_{pm}_{delta_delta_coeff}, a_data_{cosm_par}_{pm}_{delta_delta_coeff}, b_data_{cosm_par}_{pm}_{delta_delta_coeff}, c_data_{cosm_par}_{pm}_{delta_delta_coeff}, scale_factor_data_{cosm_par}_{pm}_{delta_delta_coeff}, window_c_data_{cosm_par}_{pm}_{delta_delta_coeff}, window_s_data_{cosm_par}_{pm}_{delta_delta_coeff}, mps_data_{cosm_par}_{pm}_{delta_delta_coeff}, z_at_chi_data_{cosm_par}_{pm}_{delta_delta_coeff})

cdef double lps_{cosm_par}_{pm}_{delta_delta_coeff}(int l, char* type1, char* type2) noexcept nogil:
    return lps(l, type1, type2, lps_cc_data_{cosm_par}_{pm}_{delta_delta_coeff}, lps_cs_data_{cosm_par}_{pm}_{delta_delta_coeff}, lps_ss_data_{cosm_par}_{pm}_{delta_delta_coeff}, cmbps_{cosm_par}_{pm}_{delta_delta_coeff})
            '''
