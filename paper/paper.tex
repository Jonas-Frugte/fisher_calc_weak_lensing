% !TEX root = /Users/jonasfrugte/Desktop/Research_Project/fisher_calc_weak_lensing/paper/paper.tex
...
\begin{document}
\begin{center}
    \textit{Please note:}\\ This is still a draft version of the paper I am planning to finish April 2025. It thus may still contain mistakes, missing citations, typo's, etc. that will not be present in the final version. The code used to write this paper can be found on my GitHub: \url{https://github.com/Jonas-Frugte/fisher_calc_weak_lensing}.
\end{center}
\pagebreak
\maketitle
