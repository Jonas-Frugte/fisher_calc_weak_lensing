...
\begin{table}
 ...
 \begin{tabular}{|l|r|rrr|rrr|rrr|}
        ...
        \hline
$m_\nu$ & 10 & 0.62 & 2.36 & 0.50 (\greenfactor{1.25}) & 0.033 & 0.155 & 0.031 (\greenfactor{1.06}) & 0.028 & 0.145 & 0.026 (\greenfactor{1.05}) \\
\rowcolor{blue!10}
       &    &      & 2.19 & 0.52 (\greenfactor{1.21}) &       & 0.157 & 0.031 (\greenfactor{1.06}) &      & 0.148 & 0.026 (\greenfactor{1.06}) \\

$w_0$  & 10 & 0.60 & 1.61 & 0.46 (\greenfactor{1.32}) & 0.048 & 0.107 & 0.019 (\greenfactor{2.55}) & 0.015 & 0.056 & 0.011 (\greenfactor{1.36}) \\
\rowcolor{blue!10}
       &    &      & 0.99 & 0.37 (\greenfactor{1.63}) &      & 0.105 & 0.019 (\greenfactor{2.55}) &      & 0.058 & 0.011 (\greenfactor{1.35}) \\

$\sigma_8$ & 2.5 & 0.13 & 0.24 & 0.084 (\greenfactor{1.56}) & 0.0053 & 0.0090 & 0.0039 (\greenfactor{1.35}) & 0.0041 & 0.0084 & 0.0033 (\greenfactor{1.24}) \\
\rowcolor{blue!10}
       &     &      & 0.22 & 0.084 (\greenfactor{1.56}) &      & 0.0091 & 0.0039 (\greenfactor{1.35}) &      & 0.0084 & 0.0033 (\greenfactor{1.23}) \\

$\Omega_m$ & 0.67 & 0.19 & 0.19 & 0.091 (\greenfactor{2.11}) & 0.0056 & 0.0086 & 0.0042 (\greenfactor{1.31}) & 0.0052 & 0.0082 & 0.0041 (\greenfactor{1.27}) \\
\rowcolor{blue!10}
       &      &      & 0.19 & 0.085 (\greenfactor{2.26}) &      & 0.0087 & 0.0043 (\greenfactor{1.31}) &      & 0.0081 & 0.0041 (\greenfactor{1.28}) \\
        ...
        Par & prior & $C_\ell$ & $B$ & $C_\ell + B$ & $C_\ell$ & $B$ & $C_\ell + B$ & $C_\ell$ & $B$ & $C_\ell + B$ \\
        \hline
$m_\nu$ & 0.22 & 0.083 & 0.165 & 0.082 (\greenfactor{1.01}) & 0.029 & 0.106 & 0.028 (\greenfactor{1.04}) & 0.023 & 0.093 & 0.022 (\greenfactor{1.05}) \\
\rowcolor{blue!10}
       &      &       & 0.164 & 0.082 (\greenfactor{1.00}) &      & 0.107 & 0.028 (\greenfactor{1.03}) &      & 0.095 & 0.022 (\greenfactor{1.05}) \\

$w_0$ & 0.062 & 0.054 & 0.059 & 0.054 (\greenfactor{1.00}) & 0.017 & 0.032 & 0.013 (\greenfactor{1.30}) & 0.013 & 0.029 & 0.010 (\greenfactor{1.30}) \\
\rowcolor{blue!10}
      &       &       & 0.059 & 0.054 (\greenfactor{1.00}) &      & 0.032 & 0.013 (\greenfactor{1.30}) &      & 0.030 & 0.010 (\greenfactor{1.29}) \\

$\sigma_8$ & 0.021 & 0.016 & 0.017 & 0.016 (\greenfactor{1.00}) & 0.0042 & 0.0067 & 0.0034 (\greenfactor{1.24}) & 0.0039 & 0.0064 & 0.0032 (\greenfactor{1.23}) \\
\rowcolor{blue!10}
       &       &      & 0.017 & 0.016 (\greenfactor{1.00}) &      & 0.0067 & 0.0034 (\greenfactor{1.24}) &      & 0.0065 & 0.0032 (\greenfactor{1.23}) \\

$\Omega_m$ & 0.018 & 0.016 & 0.017 & 0.016 (\greenfactor{1.00}) & 0.0049 & 0.0069 & 0.0039 (\greenfactor{1.25}) & 0.0048 & 0.0067 & 0.0038 (\greenfactor{1.25}) \\
\rowcolor{blue!10}
       &       &      & 0.017 & 0.016 (\greenfactor{1.00}) &      & 0.0070 & 0.0039 (\greenfactor{1.25}) &      & 0.0068 & 0.0038 (\greenfactor{1.25}) \\
...
Par & prior & $C_\ell$ & $B$ & $C_\ell+B$ & $C_\ell$ & $B$ & $C_\ell+B$ & $C_\ell$ & $B$ & $C_\ell+B$ \\
\hline
$H_0$ & 17 & 16 & 17 & 8.1 (2.0) & 0.5 & 1.4 & 0.47 (1.2) & 0.52 & 1.3 & 0.44 (1.2)\\
\rowcolor{blue!10}
 & & & 16 & 7.2 (2.3) & & 1.4 & 0.47 (1.2) & & 0.9 & 0.43 (1.2) \\

$10^4\Omega_b h^2$ & 5 & 5.0 & 5.0 & 5.0 (1.0) & 4.9 & 5.0 & 4.8 (1.0) & 4.8 & 5.0 & 4.8 (1.0) \\
\rowcolor{blue!10}
 & & & 5.0 & 5.0 (1.0) & & 5.0 & 4.8 (1.0) & & 4.9 & 4.7 (1.0) \\

$10^3\Omega_c h^2$ & 290 & 7.1 & 23 & 6.7 (1.1) & 1.3 & 5.6 & 1.3 (1.0) & 1.2 & 5.0 & 1.2 (1.0)\\
\rowcolor{blue!10}
 & & & 23 & 5.1 (1.4) & & 5.5 & 1.3 (1.0) & & 2.8 & 1.1 (1.1) \\

$10^3(n_s-1)$ & 20 & 19 & 20 & 19 (1.0) & 9.1 & 17 & 5.8 (1.6) & 5.5 & 17 & 5.0 (1.1) \\
\rowcolor{blue!10}
 & & & 20 & 18 (1.1) & & 17 & 5.8 (1.6) & & 11 & 4.9 (1.1) \\

$10^2\tau$ & 6 & 6 & 6 & 6 (1.0) & 6 & 6 & 6 (1.0) & 6 & 6 & 6 (1.0)\\
\rowcolor{blue!10}
 & & & 6 & 6 (1.0) & & 6 & 6 (1.0) & & 6 & 6 (1.0) \\

$m_\nu$ & 10 & 0.6 & 2.4 & 0.5 (1.3) & 0.03 & 0.16 & 0.03 (1.1) & 0.03 & 0.15 & 0.03 (1.1)\\
\rowcolor{blue!10}
 & & & 2.2 & 0.52 (1.2) & & 0.16 & 0.03 (1.1) & & 0.15 & 0.03 (1.1) \\

$w_0$ & 10 & 0.6 & 1.6 & 0.46 (1.3) & 0.05 & 0.11 & 0.02 (2.5) & 0.02 & 0.06 & 0.01 (1.4)\\
\rowcolor{blue!10}
 & & & 1.0 & 0.37 (1.6) & & 0.10 & 0.02 (2.5) & & 0.06 & 0.01 (1.3) \\

$\log_{10}(T_{\rm AGN})$ & 10 & 0.9 & 2.2 & 0.75 (1.2) & 0.06 & 0.10 & 0.04 (1.7) & 0.03 & 0.07 & 0.03 (1.2)\\
\rowcolor{blue!10}
 & & & 1.9 & 0.76 (1.2) & & 0.09 & 0.04 (1.7) & & 0.07 & 0.03 (1.2) \\
...
Par & prior & $C_\ell$ & $B$ & $C_\ell+B$ & $C_\ell$ & $B$ & $C_\ell+B$ & $C_\ell$ & $B$ & $C_\ell+B$\\
\hline
$H_0$ & 1.4 & 1.3 & 1.4 & 1.3 (1.0) & 0.4 & 0.6 & 0.31 (1.3) & 0.39 & 0.55 & 0.30 (1.3)\\
\rowcolor{blue!10}
 & & & 1.4 & 1.3 (1.0) & & 0.6 & 0.31 (1.3) & & 0.55 & 0.30 (1.3) \\

$10^4\Omega_b h^2$ & 0.65 & 0.61 & 0.64 & 0.61 (1.0) & 0.57 & 0.55 & 0.54 (1.1) & 0.54 & 0.55 & 0.52 (1.0)\\
\rowcolor{blue!10}
 & & & 0.64 & 0.61 (1.0) & & 0.55 & 0.54 (1.1) & & 0.55 & 0.52 (1.0) \\

$10^3\Omega_c h^2$ & 0.87 & 0.83 & 0.86 & 0.83 (1.0) & 0.52 & 0.65 & 0.44 (1.2) & 0.38 & 0.63 & 0.35 (1.1)\\
\rowcolor{blue!10}
 & & & 0.85 & 0.82 (1.0) & & 0.65 & 0.44 (1.2) & & 0.64 & 0.35 (1.1) \\

$10^3(n_s-1)$ & 2.6 & 2.6 & 2.6 & 2.6 (1.0) & 2.2 & 2.4 & 2.1 (1.0) & 1.9 & 2.3 & 1.8 (1.1)\\
\rowcolor{blue!10}
 & & & 2.6 & 2.6 (1.0) & & 2.4 & 2.1 (1.0) & & 2.4 & 1.8 (1.1) \\

$10^2\tau$ & 2.1 & 1.2 & 1.4 & 1.2 (1.0) & 0.8 & 1.0 & 0.67 (1.2) & 0.61 & 1.0 & 0.57 (1.1)\\
\rowcolor{blue!10}
 & & & 1.3 & 1.2 (1.0) & & 1.0 & 0.67 (1.2) & & 1.0 & 0.57 (1.1) \\

$m_\nu$ & 0.22 & 0.08 & 0.16 & 0.08 (1.0) & 0.03 & 0.11 & 0.03 (1.0) & 0.02 & 0.09 & 0.02 (1.1)\\
\rowcolor{blue!10}
 & & & 0.16 & 0.08 (1.0) & & 0.11 & 0.03 (1.0) & & 0.10 & 0.02 (1.1) \\

$w_0$ & 0.06 & 0.05 & 0.06 & 0.05 (1.0) & 0.02 & 0.03 & 0.01 (1.3) & 0.01 & 0.03 & 0.01 (1.3)\\
\rowcolor{blue!10}
 & & & 0.06 & 0.05 (1.0) & & 0.03 & 0.01 (1.3) & & 0.03 & 0.01 (1.3) \\

$\log_{10}(T_{\rm AGN})$ & 16 & 0.18 & 0.54 & 0.17 (1.0) & 0.03 & 0.04 & 0.03 (1.2) & 0.03 & 0.04 & 0.02 (1.2)\\
\rowcolor{blue!10}
 & & & 0.49 & 0.17 (1.0) & & 0.04 & 0.03 (1.2) & & 0.04 & 0.02 (1.2) \\
