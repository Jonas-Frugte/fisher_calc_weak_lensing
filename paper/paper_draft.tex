...
\begin{figure}[t]
    ...
    \caption{Central difference approximation of derivative of equilateral CMB weak lensing bispectrum for differences as specified in table \ref{tab:cosmo-params-diff} as well as for differences $5\%$ and $10\%$ larger and smaller.}
