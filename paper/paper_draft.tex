...
\subsection{Nonlinear matter powerspectrum}
...
\end{equation*}
with $\mathcal P_{l_1l_2l_3}$ defined as the number of distinct permutations that can be made with $l_1l_2l_3$

When only considering autospectra the formulas simplify to
\begin{equation*}
